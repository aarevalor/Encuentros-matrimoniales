...
export class EditarSacerdoteComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.obtenerSacerdote(elementId).subscribe((data) => {
      ...
      this.editarSacerdoteForm.controls["fechaCreacion"].setValue(
        fechaFormateada
      );
      this.editarSacerdoteForm.controls["jornadaDialogo"].setValue(
        data.response.jornadaDialogo
      );
      this.editarSacerdoteForm.controls["retornoEspiritual"].setValue(
        data.response.retornoEspiritual
      );
      this.editarSacerdoteForm.controls["lenguajeAmor"].setValue(
        data.response.lenguajeAmor
      );
      this.editarSacerdoteForm.controls["guiaDeRelacion"].setValue(
        data.response.guiaDeRelacion
      );
      this.editarSacerdoteForm.controls["sacramento"].setValue(
        data.response.sacramento
      );
      this.editarSacerdoteForm.controls["diosEnSacramento"].setValue(
        data.response.diosEnSacramento
      );
      this.editarSacerdoteForm.controls["diosEnVida"].setValue(
        data.response.diosEnVida
      );
      this.editarSacerdoteForm.controls["patronesComportamiento"].setValue(
        data.response.patronesComportamiento
      );
      this.editarSacerdoteForm.controls["dialogoProfundo"].setValue(
        data.response.dialogoProfundo
      );
      this.editarSacerdoteForm.controls["servidoresPostEncuentro"].setValue(
        data.response.servidoresPostEncuentro
      );
      this.editarSacerdoteForm.controls["formacionAcompanantes"].setValue(
        data.response.formacionAcompanantes
      );
      this.editarSacerdoteForm.controls["padreNuestro"].setValue(
        data.response.padreNuestro
      );
      this.editarSacerdoteForm.controls["transmisionNacional"].setValue(
  ...
  editarSacerdote() {
    ...
    if (this.httpOptions) {
      this.http
        .post(
          "https://encuentro-matrimonial-backend.herokuapp.com/formacion/sacerdote/update",
          jsonSacerdote,
          this.httpOptions
        )
        .subscribe(
