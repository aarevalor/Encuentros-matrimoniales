...
export class MatrimoniosGridComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http
      .get(
        `https://encuentro-matrimonial-backend.herokuapp.com/formacion/matrimonio/getAll?id=${userId}`,
        this.httpOptions
      )
      .subscribe((response) => {
  ...
  public deleteRow(row) {
    ...
    const response = this.http.post(
      `https://encuentro-matrimonial-backend.herokuapp.com/formacion/matrimonio/delete?id=${params.id}`,
      {},
      httpOptions
    );
